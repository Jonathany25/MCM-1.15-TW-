...
public class BoysDimensionChunkGenerator extends NoiseChunkGenerator<BoysDimensionGenSettings> {
    ...
    public BoysDimensionChunkGenerator(IWorld worldIn, BiomeProvider provider, BoysDimensionGenSettings settingsIn) {
