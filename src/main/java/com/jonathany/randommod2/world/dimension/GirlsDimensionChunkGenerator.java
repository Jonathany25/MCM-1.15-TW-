...
public class GirlsDimensionChunkGenerator extends NoiseChunkGenerator<GirlsDimensionGenSettings> {
    ...
    public GirlsDimensionChunkGenerator(IWorld worldIn, BiomeProvider provider, GirlsDimensionGenSettings settingsIn) {
